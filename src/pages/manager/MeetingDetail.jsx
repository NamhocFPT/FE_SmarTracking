...
import { getMeetingById, updateMeeting, cancelMeeting, getRooms, getUsers } from '../../service/managerServices';
...
const ManagerMeetingDetail = () => {
    ...
    const fetchMeeting = useCallback(async () => {
        ...
        try {
            ...
            // Mock fallbacks for manager meeting detail
            const localUserStr = localStorage.getItem('user');
        ...
        <div className="max-w-5xl mx-auto space-y-6 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex gap-2 w-full sm:w-auto">
                    ...
                    {canJoin && (
                        <button
                            onClick={() => navigate(`/manager/in-meeting/${meeting.id}`)}
