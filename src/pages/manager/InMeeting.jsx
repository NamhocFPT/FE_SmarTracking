...
import { getMeetingById, checkInMeeting, startMeeting } from '../../service/managerServices';

const ManagerInMeeting = () => {
    const { id } = useParams();
    ...
    useEffect(() => {
        const fetchDetails = async () => {
            ...
            try {
                ...
                const localUserStr = localStorage.getItem('user');
                let userObj = { id: 'mgr-uuid', fullName: 'Quản lý mẫu' };
                if (localUserStr) {
                ...
                const mock = {
                    ...
                    host: userObj.fullName || 'Nguyễn Văn A',
                    hostId: userObj.id || 'mgr-uuid',
                    host_id: userObj.id || 'mgr-uuid',
                    status: 'in_progress',
        ...
        <div className="max-w-6xl mx-auto space-y-6 animate-fade-in-up">
            ...
            <div className="flex items-center justify-between border-b border-platinum-tint pb-4">
                <div className="flex items-center gap-3">
                    <button
                        onClick={() => navigate(`/manager/meeting/${meeting.id}`)}
            ...
            {stage === 'console' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    {/* Right: Live Agenda Tracker & Live Attendance */}
...
export default ManagerInMeeting;
