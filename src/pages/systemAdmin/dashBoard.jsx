...
const DashBoard = () => {
    ...
    const fetchDashboardData = useCallback(async () => {
        ...
        setError(null);
        try {
            const [devicesRes, logsRes] = await Promise.allSettled([
            ...
            <div className="bg-white p-6 rounded-2xl border border-platinum-tint shadow-sm-1 animate-fade-in-up delay-200">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    >
                        ...
                        <span className="text-sm font-semibold text-midnight-indigo">Hồ sơ cá nhân</span>
                    </Link>
                    ...
                    >
                        ...
                        <span className="text-sm font-semibold text-midnight-indigo">Đăng ký thiết bị</span>
                    </Link>
                    ...
                    >
                        ...
                        <span className="text-sm font-semibold text-midnight-indigo">Nhật ký hệ thống</span>
                    </Link>
